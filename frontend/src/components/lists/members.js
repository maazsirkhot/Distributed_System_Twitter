        ...
        <div className="row">
          ...
          <div className="col-md-11">
            <h6 className="font-weight-bolder">
              <a href={`/view/profile/${this.props.value._id}`} className="text-dark">
                {this.props.value.name}
                {' '}
              </a>
            </h6>
            <h6 className="font-weight-lighter text-secondary">
              <a href={`/view/profile/${this.props.value._id}`} className="text-secondary">
@
                {this.props.value.userName}
              </a>
            </h6>
            <h6 className="font-weight-lighter text-dark">
              {' '}
