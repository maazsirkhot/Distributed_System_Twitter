...
class FollowersOfUser extends Component {
                ...
                */}
                ...
                <div className="col-md-9 shadow pl-5 pr-5 pb-5 pt-3">
                    ...
                    <div className="border-bottom">
                        <h4 className="font-weight-bolder">List of followers</h4>
...
//export FollowersOfUser Component
export default FollowersOfUser