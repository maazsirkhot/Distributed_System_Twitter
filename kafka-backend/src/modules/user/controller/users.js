...
exports.createUser = async (req, res) => {
  ...
  try {
    ...
    const nameLength = req.body.name.length > 5 ? 5 : req.body.name.length;
...
exports.updateUserProfile = async (req, res) => {
  ...
  try {
    ...
    const details = await Users.findByIdAndUpdate(
...
exports.bookmarkTweet = async (req, res) => {
  try {
    const bookmarkedTweet = await Users.findById(req.body.userId, {
      bookmarks: 1,
    });
...
exports.followUser = async (req, res) => {
  try {
    ...
    const result = await model.follows.findAndCountAll({
      where: {
        userId: req.body.userId,
...
exports.validate = async (req, res) => responseFormer(200, null);
